...
HL_PRIM short HL_NAME(dtCrowdAgentParams_get_updateFlags)( _ref(dtCrowdAgentParams)* _this ) {
	return _unref(_this)->updateFlags;
}
HL_PRIM short HL_NAME(dtCrowdAgentParams_set_updateFlags)( _ref(dtCrowdAgentParams)* _this, short value ) {
	_unref(_this)->updateFlags = (value);
	return value;
}
DEFINE_PRIM(_I16,dtCrowdAgentParams_get_updateFlags,_IDL);
DEFINE_PRIM(_I16,dtCrowdAgentParams_set_updateFlags,_IDL _I16);

HL_PRIM short HL_NAME(dtCrowdAgentParams_get_obstacleAvoidanceType)( _ref(dtCrowdAgentParams)* _this ) {
	return _unref(_this)->obstacleAvoidanceType;
}
HL_PRIM short HL_NAME(dtCrowdAgentParams_set_obstacleAvoidanceType)( _ref(dtCrowdAgentParams)* _this, short value ) {
	_unref(_this)->obstacleAvoidanceType = (value);
	return value;
}
DEFINE_PRIM(_I16,dtCrowdAgentParams_get_obstacleAvoidanceType,_IDL);
DEFINE_PRIM(_I16,dtCrowdAgentParams_set_obstacleAvoidanceType,_IDL _I16);

HL_PRIM short HL_NAME(dtCrowdAgentParams_get_queryFilterType)( _ref(dtCrowdAgentParams)* _this ) {
	return _unref(_this)->queryFilterType;
}
HL_PRIM short HL_NAME(dtCrowdAgentParams_set_queryFilterType)( _ref(dtCrowdAgentParams)* _this, short value ) {
	_unref(_this)->queryFilterType = (value);
	return value;
}
DEFINE_PRIM(_I16,dtCrowdAgentParams_get_queryFilterType,_IDL);
DEFINE_PRIM(_I16,dtCrowdAgentParams_set_queryFilterType,_IDL _I16);

HL_PRIM void* HL_NAME(dtCrowdAgentParams_get_userData)( _ref(dtCrowdAgentParams)* _this ) {
	return _unref(_this)->userData;
}
HL_PRIM void* HL_NAME(dtCrowdAgentParams_set_userData)( _ref(dtCrowdAgentParams)* _this, void* value ) {
	_unref(_this)->userData = (value);
	return value;
}
DEFINE_PRIM(_BYTES,dtCrowdAgentParams_get_userData,_IDL);
DEFINE_PRIM(_BYTES,dtCrowdAgentParams_set_userData,_IDL _BYTES);
